<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div class="user-profile text-center mt-3">
            <div class="">
                <img src="{{asset('/backend-theme/assets/images/users/avatar-1.jpg')}}" alt=""
                class="avatar-md rounded-circle">
            </div>
            <div class="mt-3">
                <h4 class="font-size-16 mb-1">R.Case</h4>
                <span class="text-muted"><i class="ri-record-circle-line align-middle font-size-14 text-success">
                    </i> Online</span>
            </div>
        </div>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">Manage Database</a>
                            <ul class="sub-menu" aria-expanded="true">
