...
Within your index page, note the inclusion of both the extends and the section methods ()
@extends('admin.master')  takes one argument the name of your template master which in our case exists within our views admin page as master.
Next, we have a section method which takes one argument, defining the name of your template
@section('admin')
open
 my index page content goes here 
Close 
@endsection
-->
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0"><span class="text-success fw-bold font-size-12 me-2">
                                    <i class="ri-arrow-right-up-line me-1 align-middle">
                                        </i>9.23%</span>from previous period</p>
                            </div>
                            <div class="avatar-sm">
                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0"><span class="text-danger fw-bold font-size-12 me-2">
                                    <i class="ri-arrow-right-down-line me-1 align-middle">
                                        </i>1.09%</span>from previous period</p>
                            </div>
                            <div class="avatar-sm">
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0"><span class="text-success fw-bold font-size-12 me-2">
                                    <i class="ri-arrow-right-up-line me-1 align-middle">
                                        </i>11.7%</span>from previous period</p>
                            </div>
                            <div class="avatar-sm">
                                <span class="avatar-title bg-light text-success rounded-3">
