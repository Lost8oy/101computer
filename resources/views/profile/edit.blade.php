        ...
        <div class="card-body">
            ...
            <!-- end row -->
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <img id="showImage" class="rounded-circle avatar-xl" src="{{ (!empty($user->profile_image))? url('uploads/profile/images/'.$user->profile_image):url('uploads/profile/images/no_image.jpg') }}"> </div>
            </div>
            <!-- end row -->
